...
onMounted(async() => {
    try {
        ...
        toast.error('Job fetching is failed')
    } finally {
...
<template>
  <section v-if="!state.isLoading" class="bg-green-50">
    <div class="container m-auto max-w-2xl py-24">
      <div
        class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border border-gray-200 m-4 md:m-0"
      >
        <form @submit.prevent="handleSubmit">
          ...
          <div class="mb-4">
            ...
            <input
              ...
              id="name"
              name="name"
              class="border border-gray-200 rounded w-full py-2 px-3 mb-2"
